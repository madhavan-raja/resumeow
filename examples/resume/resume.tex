\documentclass{resumeow}

\name{Catthew MeowConaughey}
\phone{(666) 666-6666}
\email{hr@hell.com}
\website{cats.org.uk}
\linkedin{linkedin.com/company/cats-protection/}
...
\begin{document}
    ...
    \ExperienceList{
        \item \experience
            {Associate Catnip Sniffer}
            {Pawtopia Catnip Co.}
            {USA}
            {Jun 2024 - Present}
            {
                \item Conducted paws-on quality assurance sniff tests of premium catnip.
